...
It would be nice if we could save it in a way that would allow us to reuse it later. Here is an example of saving some ops from a graph for reuse later.
